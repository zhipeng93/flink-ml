...
class _SwingParams(
    ...
    MIN_USER_BEHAVIOR: Param[int] = IntParam(
        "min_user_behavior",
        "The min number of items for a user purchases. If the items purchased by a user is "
        + "smaller than this value, then this user is filtered out while gathering data. This can "
    ...
    MAX_USER_BEHAVIOR: Param[int] = IntParam(
        ...
        + "larger than this value, then this user is filtered out while gathering data. This can "
