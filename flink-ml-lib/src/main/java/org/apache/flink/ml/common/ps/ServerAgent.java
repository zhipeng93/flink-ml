...
public class ServerAgent {
    ...
    void push(long[] indices, double[] values, int stageId) {
    ...
    void pull(long[] indices, int stageId) {
     ...
     */
    <V> void allReduce(V[] values, TypeSerializer<V> typeSerializer, int stageId)
            throws IOException {
