 ...
 *
 * <p>`serverId serverId stageId messageType keyLength keys valuesLength values`
 *
 * <p>where the message fields include the server ID, worker ID, stage ID, message type, length of
...
public class Message {
    ...
    private static final int MESSAGE_TYPE_OFFSET = Integer.BYTES + STAGE_ID_OFFSET;
    ...
    public static Message assembleMessages(Iterator<byte[]> messageIterator) {
        ...
        for (Message message : messages) {
            ...
            Preconditions.checkState(
                    messageType == null || messageType == message.getMessageType());
        ...
        Bits.putInt(assembledBytes, MESSAGE_TYPE_OFFSET, messageType.type);
