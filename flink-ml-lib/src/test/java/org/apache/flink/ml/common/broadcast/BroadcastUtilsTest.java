...
public class BroadcastUtilsTest {
    ...
    private static Function<List<DataStream<?>>, DataStream<Integer>> getFunc(int numInputs) {
        if (numInputs == 1) {
            ...
            return dataStreams -> {
                ...
                return new MultipleConnectedStreams(env)
    ...
    public void test() throws Exception {
        ...
        DataStream<Integer> source1 = env.addSource(new TestSource(1));
        source1.transform("udf", BasicTypeInfo.INT_TYPE_INFO, new OneInputUdfOp(new A()))
                .addSink(
    ...
    private static class OneInputUdfOp extends AbstractUdfStreamOperator<Integer, RichFunction>
            implements OneInputStreamOperator<Integer, Integer>, BoundedOneInput {

        public OneInputUdfOp(RichFunction userFunction) {
            super(userFunction);
        }
    ...
    private static class A extends AbstractRichFunction {}
}
