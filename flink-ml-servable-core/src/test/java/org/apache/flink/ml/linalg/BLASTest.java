...
public class BLASTest {
    ...
    public void testScal() {
        ...
        SparseIntDoubleVector inputSparseIntDoubleVector =
                Vectors.sparse(5, new int[] {0, 2, 4}, new double[] {1, 3, 5});
        BLAS.scal(1.5, inputSparseIntDoubleVector);

        double[] expectedSparseResult = new double[] {1.5, 4.5, 7.5};
        int[] expectedSparseIndices = new int[] {0, 2, 4};

        assertArrayEquals(expectedSparseResult, inputSparseIntDoubleVector.values, TOLERANCE);
        assertArrayEquals(expectedSparseIndices, inputSparseIntDoubleVector.indices);
    }
